...
@par Directory contents 
    - COM.MXCHIP.BASIC/http/http_sever/http_sever.c      Applicaiton program
    - COM.MXCHIP.BASIC/http/http_sever/app_httpd.c      Applicaiton program
    - COM.MXCHIP.BASIC/http/http_sever/web_data.c      Webpage applicaiton program
    - COM.MXCHIP.BASIC/http/http_sever/mico_config.h   MiCO function header file
    - COM.MXCHIP.BASIC/http/http_sever/app_httpd.h     app_httpd.c header file
