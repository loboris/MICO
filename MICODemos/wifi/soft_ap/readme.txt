/**
  @page "wifi_softap"  demo
  
  @verbatim
  ******************** (C) COPYRIGHT 2015 MXCHIP MiCO SDK*******************
  * @file    wifi_softap/readme.txt 
...
@par Directory contents 
    - COM.MXCHIP.BASIC/wifi/softap/wifi_softap.c     Applicaiton program
    - COM.MXCHIP.BASIC/wifi/softap/mico_config.h   MiCO function header file
