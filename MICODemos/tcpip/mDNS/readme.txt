/**
  ...
  ******************************************************************************
  ...
  This demo shows:  how to make device  found by other device through bonjour sevice, after Easylink configuration.


@par Directory contents 
    - COM.MXCHIP.BASIC/tcpip/mDNS/mdns.c              Applicaiton program
    - COM.MXCHIP.BASIC/tcpip/mDNS/mico_config.h   MiCO function header file
