/**
  @page " http_ssl_client "  demo
  
  @verbatim
  ******************** (C) COPYRIGHT 2015 MXCHIP MiCO SDK*******************
  * @file    http_ssl_client/readme.txt 
  * @author  MDWG (MiCO Documentation Working Group)
  * @version v2.3.x
  * @date    24-August-2015
  * @brief   Description of the  "http_ssl_client"  demo.
  ******************************************************************************


  @par Demo Description 
  This demo shows:  how to start http client to communicate according to SSL


@par Directory contents 
    - COM.MXCHIP.BASIC/http/http_client/http_ssl_client.c              Applicaiton program
    - COM.MXCHIP.BASIC/http/http_ssl_client/mico_config.h           MiCO function header file
